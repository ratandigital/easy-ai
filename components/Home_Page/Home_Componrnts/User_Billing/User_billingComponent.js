...
export default function User_billingComponent() {
  return (
    <>
    {/* User Billing Page */}
        ...
        <div className="techwave_fn_user_billing">
          ...
          <div className="billing__activation">
            ...
            <div className="activation_actions">
              <a href="pricing.html" className="techwave_fn_button">
                <span>Upgrade Plan</span>
              </a>
              <a href="pricing.html" className="disabled techwave_fn_button">
